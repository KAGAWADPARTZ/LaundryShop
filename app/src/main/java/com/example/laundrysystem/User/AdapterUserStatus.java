...
public class AdapterUserStatus extends FirebaseRecyclerAdapter<LaundryMainModel, AdapterUserStatus.myViewHolder> {

    private OnItemClickListener listener;

    public AdapterUserStatus(@NonNull FirebaseRecyclerOptions<LaundryMainModel> options) {
        super(options);
    }
